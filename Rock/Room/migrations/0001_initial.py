# Generated by Django 5.2.8 on 2025-12-20 06:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['song'], name='Room_vote_song_id_3be525_idx'), models.Index(fields=['user'], name='Room_vote_user_id_01d78b_idx'), models.Index(fields=['room'], name='Room_vote_room_id_8d3a39_idx')],
